...
var Authenticator = /** @class */ (function (_super) {
    ...
    Authenticator.prototype.checkUser = function () {
        ...
        return auth_1.default.currentAuthenticatedUser()
            ...
            auth_1.default.signOut().then(function () { return _this.handleStateChange(_this._initialAuthState); });
        });
    };
    ...
    Authenticator.prototype.handleAuthEvent = function (state, event) {
        if (event.type === 'error') {
    ...
    Authenticator.prototype.render = function () {
        var _this = this;
        var _a = this.state, auth = _a.auth, authData = _a.authData;
        var theme = this.props.theme || Amplify_UI_Theme_1.default;
        var messageMap = this.props.errorMessage || AmplifyMessageMap_1.default;
        var _b = this.props, hideDefault = _b.hideDefault, _c = _b.hide, hide = _c === void 0 ? [] : _c, federated = _b.federated;
        if (hideDefault) {
            hide = hide.concat([
                Greetings_1.default,
                SignIn_1.default,
        ...
        var props_children_names = React.Children.map(props_children, function (child) { return child.type.name; });
        var props_children_override = React.Children.map(props_children, function (child) { return child.props.override; });
        hide = hide.filter(function (component) { return !props_children_names.includes(component.name); });
        var hideLink = hide.filter(function (component) {
            return !props_children_override.some(function (comp) { return comp === component; });
        });
        ...
        return (React.createElement(Amplify_UI_Components_React_1.Container, { theme: theme },
            this.state.showToast &&
                React.createElement(Amplify_UI_Components_React_1.Toast, { onClose: function () { return _this.setState({ showToast: false }); } }, core_1.I18n.get(error)),
            render_children));
    };
