...
var SignIn = /** @class */ (function (_super) {
    ...
    SignIn.prototype.signIn = function () {
        ...
        auth_1.default.signIn(username, password)
            ...
            if (err.code === 'UserNotConfirmedException') {
                ...
                _this.changeState('confirmSignUp', { username: username });
            }
            else if (err.code === 'PasswordResetRequiredException') {
                logger.debug('the user requires a new password');
                _this.changeState('requireNewPassword', { username: username });
            }
            else {
                _this.error(err);
            }
    ...
    SignIn.prototype.showComponent = function (theme) {
        var _this = this;
        var _a = this.props, authState = _a.authState, _b = _a.hide, hide = _b === void 0 ? [] : _b, federated = _a.federated, onStateChange = _a.onStateChange, onAuthEvent = _a.onAuthEvent, _c = _a.hideLink, hideLink = _c === void 0 ? [] : _c;
        if (hide && hide.includes(SignIn)) {
            return null;
        }
        var hideSignUp = hideLink.some(function (component) { return component.name === 'SignUp'; });
        var hideForgotPassword = hideLink.some(function (component) { return component.name === 'ForgotPassword'; });
