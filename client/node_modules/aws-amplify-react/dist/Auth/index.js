...
function withAuthenticator(Comp, includeGreetings, authenticatorComponents, federated, theme) {
        ...
        class_1.prototype.render = function () {
            ...
            if (signedIn) {
                return (React.createElement("div", null,
                    includeGreetings ?
                        React.createElement(Greetings_2.default, { authState: authState, authData: authData, federated: federated || this.props.federated, onStateChange: this.handleAuthStateChange })
                        : null,
            ...
            return React.createElement(Authenticator_1.default, __assign({}, this.props, { theme: theme, federated: federated || this.props.federated, hideDefault: authenticatorComponents.length > 0, onStateChange: this.handleAuthStateChange, children: authenticatorComponents }));
        };
        return class_1;
    }(react_1.Component));
}
